...
const BRACKET_MATCHES: Record<Exclude<BracketStageType, 'WINNER'>, BracketMatch> = {
  R32: [
    ...
    { date: '4 Lug - 00:00',  teams: [ { dbString: 'R32_SEDICESIMI_1J', label: '1° Gruppo J' }, { dbString: 'R32_SEDICESIMI_2H', label: '2° Gruppo H' } ] },
    { date: '3 Lug - 20:00',  teams: [ { dbString: 'R32_SEDICESIMI_2D', label: '2° Gruppo D' }, { dbString: 'R32_SEDICESIMI_2G', label: '2° Gruppo G' } ] },
    { date: '3 Lug - 04:00',  teams: [ { dbString: 'R32_SEDICESIMI_1B', label: '1° Gruppo B' }, { dbString: 'R32_SEDICESIMI_3M7', label: '3° Migliore' } ] },
    { date: '4 Lug - 03:30',  teams: [ { dbString: 'R32_SEDICESIMI_1K', label: '1° Gruppo K' }, { dbString: 'R32_SEDICESIMI_3M8', label: '3° Migliore' } ] },
  ],
  R16: [
    ...
    { date: '6 Lug - 21:00', teams: [ { dbString: 'R16_OTTAVI_V5', label: 'Vinc. Sedicesimi 5' }, { dbString: 'R16_OTTAVI_V6', label: 'Vinc. Sedicesimi 6' } ] },
    { date: '7 Lug - 02:00', teams: [ { dbString: 'R16_OTTAVI_V7', label: 'Vinc. Sedicesimi 7' }, { dbString: 'R16_OTTAVI_V8', label: 'Vinc. Sedicesimi 8' } ] },
    { date: '5 Lug - 22:00', teams: [ { dbString: 'R16_OTTAVI_V9', label: 'Vinc. Sedicesimi 9' }, { dbString: 'R16_OTTAVI_V10', label: 'Vinc. Sedicesimi 10' } ] },
    { date: '6 Lug - 02:00', teams: [ { dbString: 'R16_OTTAVI_V11', label: 'Vinc. Sedicesimi 11' }, { dbString: 'R16_OTTAVI_V12', label: 'Vinc. Sedicesimi 12' } ] },
    { date: '7 Lug - 18:00', teams: [ { dbString: 'R16_OTTAVI_V13', label: 'Vinc. Sedicesimi 13' }, { dbString: 'R16_OTTAVI_V14', label: 'Vinc. Sedicesimi 14' } ] },
    { date: '7 Lug - 22:00', teams: [ { dbString: 'R16_OTTAVI_V15', label: 'Vinc. Sedicesimi 15' }, { dbString: 'R16_OTTAVI_V16', label: 'Vinc. Sedicesimi 16' } ] },
  ],
  QF: [
    { date: '9 Lug - 22:00', teams: [ { dbString: 'QF_QUARTI_V1', label: 'Vinc. Ottavi 1' }, { dbString: 'QF_QUARTI_V2', label: 'Vinc. Ottavi 2' } ] },
    { date: '10 Lug - 21:00', teams: [ { dbString: 'QF_QUARTI_V3', label: 'Vinc. Ottavi 3' }, { dbString: 'QF_QUARTI_V4', label: 'Vinc. Ottavi 4' } ] },
    { date: '11 Lug - 23:00', teams: [ { dbString: 'QF_QUARTI_V5', label: 'Vinc. Ottavi 5' }, { dbString: 'QF_QUARTI_V6', label: 'Vinc. Ottavi 6' } ] },
    { date: '12 Lug - 03:00', teams: [ { dbString: 'QF_QUARTI_V7', label: 'Vinc. Ottavi 7' }, { dbString: 'QF_QUARTI_V8', label: 'Vinc. Ottavi 8' } ] },
  ],
  SF: [
    { date: '14 Lug - 21:00', teams: [ { dbString: 'SF_SEMIFINALI_V1', label: 'Vinc. Quarti 1' }, { dbString: 'SF_SEMIFINALI_V2', label: 'Vinc. Quarti 2' } ] },
    { date: '15 Lug - 21:00', teams: [ { dbString: 'SF_SEMIFINALI_V3', label: 'Vinc. Quarti 3' }, { dbString: 'SF_SEMIFINALI_V4', label: 'Vinc. Quarti 4' } ] },
  ],
  F: [
